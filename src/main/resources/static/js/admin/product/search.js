$(document).ready(function () {
    ...
    btnSearch.on("click", function (e) {
        ...
        fetchProduct({filter, categoryId: CATEGORY_ID});
    })
    ...
    function fetchProduct(
        ...
        let swal = null;
        $.ajax({
            url: `/product/get?filter=${filter}&page=${page}&size=${size}&categoryId=${categoryId}`,
            method: "GET",
            headers: {
                            ...
                            <div class="app-card app-card-doc shadow-sm  h-100">
                                <div class="app-card-thumb-holder p-3">
                                    <div class="app-card-thumb">
                                        <img class="thumb-image" src="${product?.image ? product.image : '/images/doc-thumb-1.jpg'}" alt="">
                                    </div>
                                ...
                                <div class="app-card-body p-3 has-card-actions">
                                    ...
                                    <div class="app-doc-meta">
                                        <ul class="list-unstyled mb-0">
                                            <li><span class="text-muted">Quantity:</span> ${product.quantity}</li>
                                            <li><span class="text-muted">Price:</span> ${product.price}</li>
                                            <li><span class="text-muted">Created At:</span> ${product.createdAt}</li>
                                        </ul>
                                    </div><!--//app-doc-meta-->
                                    ...
                                    <div class="app-card-actions">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" data-id="${product.id}" href="#"><svg width="1em" height="1em"
                                                ...
                                                <li><a class="dropdown-item product-edit" data-id="${product.id}" href="#"><svg width="1em" height="1em"
                                                ...
                                                <li><a class="dropdown-item product-delete" data-id="${product.id}" href="#"><svg width="1em" height="1em"
